...
export async function buildMockAnalysis({
  ...
  // Test-only hook: lets us exercise the FAILURE path end-to-end without
  // real chain data. Never triggered by a real address.
  if (address === "0xfa11fa11fa11fa11fa11fa11fa11fa11fa11fa11") {
    throw new Error("Simulated mid-run failure: verification enrichment crashed");
  }
